...
public class TarferssMinecraftImprovementModMobEffects {
	public static final DeferredRegister<MobEffect> REGISTRY = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, TarferssMinecraftImprovementMod.MODID);
	public static final RegistryObject<MobEffect> BLEEDING = REGISTRY.register("bleeding", () -> new BleedingMobEffect());
	public static final RegistryObject<MobEffect> IRRADIED = REGISTRY.register("irradied", () -> new IrradiedMobEffect());
}
