...
public class TarferssMinecraftImprovementMod {
	...
	public TarferssMinecraftImprovementMod() {
		...
		TarferssMinecraftImprovementModFluids.REGISTRY.register(bus);
		TarferssMinecraftImprovementModFluidTypes.REGISTRY.register(bus);
	}
