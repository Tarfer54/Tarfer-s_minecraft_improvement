package net.mcreator.tarferssminecraftimprovement;
...
import net.mcreator.tarferssminecraftimprovement.init.TarferssMinecraftImprovementModParticleTypes;
...
@Mod("tarferss_minecraft_improvement")
public class TarferssMinecraftImprovementMod {
	public static final Logger LOGGER = LogManager.getLogger(TarferssMinecraftImprovementMod.class);
	public static final String MODID = "tarferss_minecraft_improvement";

	public TarferssMinecraftImprovementMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		TarferssMinecraftImprovementModBlocks.REGISTRY.register(modEventBus);

		TarferssMinecraftImprovementModItems.register(modEventBus);

		TarferssMinecraftImprovementModTabs.REGISTRY.register(modEventBus);

		TarferssMinecraftImprovementModMobEffects.REGISTRY.register(modEventBus);
		TarferssMinecraftImprovementModEnchantments.REGISTRY.register(modEventBus);

		TarferssMinecraftImprovementModParticleTypes.REGISTRY.register(modEventBus);

		TarferssMinecraftImprovementModFluids.REGISTRY.register(modEventBus);
		TarferssMinecraftImprovementModFluidTypes.REGISTRY.register(modEventBus);
